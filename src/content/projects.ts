...
export const projectIndex: IndexEntry[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Interviewed by Y Combinator out of a 1500+ person field. It did not reach the final three, having too broad a market and too thin a differentiator against other AI editors",
    ],
